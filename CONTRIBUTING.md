## How to contribute to dockerhubstats2mqtt

#### **Did you find a bug?**

* **Do not open up a GitHub issue if the bug is a security vulnerability
  in dockerhubstats2mqtt**, and instead write me a mail to [info@oberdorf-itc.de](mailto:info@oberdorf-itc.de).

* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/cybcon/docker.dockerhubstats2mqtt/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/cybcon/docker.dockerhubstats2mqtt/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
